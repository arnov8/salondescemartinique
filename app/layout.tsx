...
export const metadata: Metadata = {
  ...
  description: 'Le rendez-vous annuel des responsables de Comités Sociaux et Économiques (CSE) et Comités d\'Œuvres Sociales (COS) en Martinique. 1er Octobre 2026 au Palais des Congrès de Madiana.',
  keywords: ['salon', 'CSE', 'COS', 'Martinique', 'comité entreprise', 'CE', 'professionnel', '2026', 'Schœlcher', 'Madiana'],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Salon des CSE & COS de Martinique 2026',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Salon des CSE & COS de Martinique 2026',
...
const jsonLd = {
  ...
  '@type': 'Event',
  name: 'Salon des CSE & COS de Martinique 2026 - 33ème Édition',
